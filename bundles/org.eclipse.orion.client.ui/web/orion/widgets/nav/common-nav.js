...
define([
	...
	objects.mixin(CommonNavExplorer.prototype, /** @lends orion.sidebar.CommonNavExplorer.prototype */ {
		...
		registerCommands: function() {
			...
			commandRegistry.registerCommandContribution(fileActionsScope, "orion.new.autoImportProject", 5, "orion.menuBarFileGroup/orion.newContentGroup/orion.new.default"); //$NON-NLS-2$ //$NON-NLS-1$ //$NON-NLS-0$
			...
			commandRegistry.registerCommandContribution(contextMenuActionsScope, "orion.new.autoImportProject", 5, "orion.commonNavContextMenuGroup/orion.newGroup/orion.New"); //$NON-NLS-2$ //$NON-NLS-1$ //$NON-NLS-0$
